<template>
  <div class="flex flex-col items-center">
    <div
      class="bg-slate-900 text-slate-300 w-3/4 my-4 p-4 rounded-xl shadow-xl"
      v-for="blog in blogs"
      :key="blog.id"
    >
      ...
      <div class="flex">
        ...
        <span
          class="p-1 mt-1 transition-all duration-200 hover:translate-y-1 hover:scale-105 hover:rotate-12"
        >
          <svg
